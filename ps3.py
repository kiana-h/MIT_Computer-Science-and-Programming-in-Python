...
def is_valid_word(word, hand, word_list):
    ...
    returns: boolean
    """
    dic_word = get_frequency_dict(word.lower())
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand)>0:      
        ...
        if is_valid_word(word,hand,word_list):
            score_total +=get_word_score(word, calculate_handlen(hand))
            print(word, " earned ",get_word_score(word, calculate_handlen(hand))," points. Total: ",score_total ," points")
        else:
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    for i in range(rounds):
        ...
        print("Current Hand:", end=" ")
        display_hand(hand)
        sub = input ("Would you like to substitute a letter?(yes/no) ").lower()
        if sub== "yes":
