...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        all_original = lower_case + upper_case
        
        lower_case_shift = lower_case[shift:] + lower_case[:shift]
        upper_case_shift = upper_case[shift:] + upper_case[:shift]
        all_shifted = lower_case_shift + upper_case_shift
        
        return dict(zip(all_original, all_shifted))
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        self.encryption_dict = self.build_shift_dict(diff)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        result = result + (best_shift_value,) + (best_message,)
